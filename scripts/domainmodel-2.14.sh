...
export SET_TYCHO_VERSION=-Dtycho-version=1.1.0
...
mvn $SET_TYCHO_VERSION $DISABLE_DOWNLOAD_PROGRESS $SETTINGS $PROFILES -Dtycho.showEclipseLog=true -Dtargetplatform.classifier=domainmodel-$TP clean install
