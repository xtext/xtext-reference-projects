cd domainmodel/2.38.0/org.eclipse.xtext.example.domainmodel.releng
...
mvn -U -B $DISABLE_DOWNLOAD_PROGRESS $SETTINGS $PROFILES -Dtycho.showEclipseLog=true clean install $EXTRA_ARGS
