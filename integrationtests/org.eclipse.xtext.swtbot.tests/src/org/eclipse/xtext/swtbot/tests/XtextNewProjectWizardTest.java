...
public class XtextNewProjectWizardTest extends AbstractSwtBotTest {
	...
	public void simpleXtextProject() throws Exception {
		...
		mainMenu().openNewProjectWizard().selectXtextProject().selectJava21().next().toggleEclipsePlugin().toggleGenericIdeSupport()
	...
	public void xtextProject_forEclipse() throws Exception {
		...
		// create xtext project
		mainMenu().openNewProjectWizard().selectXtextProject().selectJava21().next().toggleFeature().toggleUpdateSite()
				.toggleTestingSupport().finish();
		sleep(500); // wait for asynchronous updates
		waitForBuild();
	...
	public void xtextProject_forEclipse_withTesting() throws Exception {
		...
		// create xtext project
		mainMenu().openNewProjectWizard().selectXtextProject().selectJava21().next().finish();
		sleep(500); // wait for asynchronous updates
		waitForBuild();
	...
	public void xtextProject_forEclipse_withTesting_withMaven() throws Exception {
		...
		// create xtext project
		mainMenu().openNewProjectWizard().selectXtextProject().selectJava21().next().toggleFeature().toggleUpdateSite().setMavenBuildType()
				.finish();
		sleep(500); // wait for asynchronous updates
		waitForBuild();
	...
	public void xtextProject_forEclipse_withTesting_withGradle() throws Exception {
		...
		// create xtext project
		mainMenu().openNewProjectWizard().selectXtextProject().selectJava21().next().toggleUpdateSite().setGradleBuildType().finish();
		sleep(500); // wait for asynchronous updates
		waitForBuild();
	...
	public void xtextProject_webIntegration_withLSPRegular() throws Exception {
		...
		// create xtext project
		mainMenu().openNewProjectWizard().selectXtextProject().selectJava21().next().toggleEclipsePlugin().setMavenBuildType()
